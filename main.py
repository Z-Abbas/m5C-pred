...
# -*- coding: utf-8 -*-
"""
Created on Wed May 10 14:04:14 2023
...
specie = 'human' 
data_path = '/m5C-pred/data/sample_data.txt' # path to the data
temp_file_path = "/home/zeeshan/m5C/" # Current working directory
...
preds,names = predict(temp_file_path +'temp.txt')

# print(len(bg), len(preds), len(names))
